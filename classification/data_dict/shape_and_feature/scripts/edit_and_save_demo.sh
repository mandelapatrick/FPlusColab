...
'pix2pixHD')
  ...
  64)
    ...
    # CLF_EPOCH=50
    CLF_EPOCH=120
    DATASET_DIR='/content/FashionPlus/classification/datasets/'
    ...
    CLASSIFIER_PATH='/content/FashionPlus/checkpoint/m'${PARAM_M}'k'${PARAM_K}'/'
  ;;
  *)
...
exec_options="python /content/FashionPlus/classification/data_dict/shape_and_feature/update_demo.py \
